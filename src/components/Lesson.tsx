...
export function Lesson(props: LessonProps) {
    ...
    return (
        <a href={`/lesson/${props.slug}`} className="group">
            ...
            <div className="rounded border border-gray-500 p-4 my-5 group-hover:border-blue-500">
                <header className="flex items-center justify-between">
                    ...
                    <span className="text-xs rounded py-[0.125rem] px-2 text-white border border-blue-500 font-bold">
